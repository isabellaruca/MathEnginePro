...
def theory(request):
    """Vista para mostrar el contenido teórico de álgebra"""
    content = get_theory_content()
    return render(request, 'algebra/theory.html', {'content': content})


def practice(request):
    """Vista para el módulo de práctica"""
    return render(request, 'algebra/practice.html')


@csrf_exempt
def get_exercise(request):
    """
    API endpoint para obtener un nuevo ejercicio de álgebra
    """
